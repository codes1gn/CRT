...
mod tests {
    ...
    fn test_program_const_literal() {
        let result = parse_program(CompleteStr(
    ...
    fn test_parse_program_multiline() {
        ...
        let full_result = parse_program(CompleteStr(full_bytecode));
        println!("{:#?}", full_result);
        let seg1_result = parse_program(CompleteStr(seg1_bytecode));
        println!("{:#?}", seg1_result);
        let seg2_result = parse_program(CompleteStr(seg2_bytecode));
        println!("{:#?}", seg2_result);
